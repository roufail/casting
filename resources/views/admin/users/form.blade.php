...
<div class="box">
    <div class="box-header">
      <h3 class="box-title">@if($user->id) تعديل {{$user->name}}@else مستخدم جديد @endif</h3>
    </div><!-- /.box-header -->
        ...
        <form enctype="multipart/form-data" role="form" method="POST" action="{{ $user->id ? route('admin.users.update',$user->id) : route('admin.users.store') }}">
            ...
            <div class="form-group">
              ...
              <div class="form-group">
                ...
                <input type="email" name="email" class="form-control"  value="{{old_value('email',$user)}}" placeholder="Enter email">
              </div>


              <div class="form-group">
                <label for="exampleInputEmail1">تاريخ الميلاد</label>
                <input dir="ltr" type="date" name="dob" class="form-control"  value="{{old_value('dob',$user)}}" placeholder="Enter birth date">
              </div>
              ...
              <div class="form-group">
                <label for="exampleInputEmail1">نبذه</label>
              ...
              <div class="form-group">
                <label>الخدمات</label>
                  ...
                  <a href="javascript:;" class="add_services_handler">
                    <i class="fa fa-plus"></i>اضافة خدمه جديده
                  </a>
              ...
              <div class="checkbox">
                <label>
                  <input name="active" type="checkbox" @if($user->active || old('active')) checked @endif> مفعل
                </label>
              </div>
